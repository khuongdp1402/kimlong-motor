...
export const products = [
    {
        ...
        'specs': [
            ...
            {
                'label': 'Kích thước',
                'value': '12.000 x 2.500 x 3.400 mm'
            },
            {
    ...
    },
    {
        ...
        'specs': [
            ...
            {
                'label': 'Kích thước',
                'value': '13.700 x 2.500 x 3.500 mm'
            },
            {
                'label': 'Tiêu chuẩn khí thải',
                'value': 'Euro 5'
    ...
    },
    {
        ...
        'specs': [
            ...
            {
                'label': 'Kích thước',
                'value': '12.000 x 2.500 x 3.300 mm'
            },
            {
                'label': 'Tiêu chuẩn khí thải',
                'value': 'Euro 5'
    ...
    },
    {
        ...
        'specs': [
            ...
            {
                'label': 'Kích thước',
                'value': '8.400 x 2.430 x 3.300 mm'
            },
            {
                'label': 'Tiêu chuẩn khí thải',
                'value': 'Euro 5'
    ...
    },
    {
        ...
        'specs': [
            ...
            {
                'label': 'Kích thước',
                'value': '5.995 x 2.100 x 2.750 mm'
            },
            {
                'label': 'Tiêu chuẩn khí thải',
                'value': 'Euro 4'
    ...
    {
        'id': 8,
        'name': 'KIMLONG 99 28 PHÒNG',
        'slug': 'kimlong-99-28-phong',
        'category': 'giuong-nam',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-giuong-nam-kim-long-99-24-phong-1.jpg',
        'description': 'Xe khách giường nằm Kim Long 99 28 phòng, thiết kế hiện đại.',
        'specs': [
            {
                'label': 'Số giường',
                'value': '28 giường'
    ...
    {
        'id': 9,
        'name': 'KIMLONG 99 30 PHÒNG',
        'slug': 'kimlong-99-30-phong',
        'category': 'giuong-nam',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-giuong-nam-kim-long-99-24-phong-1.jpg',
        'description': 'Xe khách giường nằm Kim Long 99 30 phòng.',
        'specs': [
            {
                'label': 'Số giường',
                'value': '30 giường'
    ...
    {
        'id': 10,
        'name': 'KIMLONG 99 32 PHÒNG',
        'slug': 'kimlong-99-32-phong',
        'category': 'giuong-nam',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-giuong-nam-kim-long-99-24-phong-1.jpg',
        'description': 'Xe khách giường nằm Kim Long 99 32 phòng.',
        'specs': [
            {
                'label': 'Số giường',
                'value': '32 giường'
    ...
    },
    {
        ...
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-ghe-ngoi-kim-long-47.jpg',
        'description': 'Xe khách ghế ngồi Kim Long 35 chỗ.',
        'specs': [
            {
                'label': 'Số ghế',
                'value': '35 + 1'
    ...
    },
    {
        ...
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-ghe-ngoi-kim-long-47.jpg',
        'description': 'Xe khách ghế ngồi Kim Long 40 chỗ.',
        'specs': [
            {
                'label': 'Số ghế',
                'value': '40 + 1'
    ...
    {
        'id': 13,
        'name': 'KIMLONG X9 12 CHỖ',
        'slug': 'kimlong-x9-12-cho',
        'category': '16-cho',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-16-cho-kim-long-x9.jpg',
        'description': 'Xe khách Kim Long X9 12 chỗ.',
        'specs': [
            {
                'label': 'Số ghế',
                'value': '12 + 1'
    ...
    {
        'id': 14,
        'name': 'KIMLONG X9 14 CHỖ',
        'slug': 'kimlong-x9-14-cho',
        'category': '16-cho',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-16-cho-kim-long-x9.jpg',
        'description': 'Xe khách Kim Long X9 14 chỗ.',
        'specs': [
            {
                'label': 'Số ghế',
                'value': '14 + 1'
    ...
    {
        'id': 15,
        'name': 'KIMLONG X9 8 CHỖ LIMOUSIN',
        'slug': 'kimlong-x9-8-cho-limousin',
        'category': 'limousine',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-limousine-kim-long.jpg',
        'description': 'Xe khách limousine Kim Long X9 8 chỗ.',
        'specs': [
            {
                'label': 'Số ghế',
                'value': '8 + 1'
    ...
    {
        'id': 16,
        'name': 'KIMLONG 35 Ghế LIMOUSIN',
        'slug': 'kimlong-35-ghe-limousin',
        'category': 'limousine',
        'price': 'Liên hệ',
        'image': 'https://kimlongmiennam.com.vn/wp-content/uploads/2024/05/xe-khach-29-limousine.jpg',
        'description': 'Xe khách limousine Kim Long 35 chỗ.',
        'specs': [
            {
                'label': 'Số ghế',
                'value': '35 + 1'
